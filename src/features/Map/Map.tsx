...
interface MapProps {
    className?: string
    children?: ReactNode
    attributesSvg: attributesSvgType | undefined
}
...
useEffect(()=>(console.log(`test${attributesSvg?.id}`)),[])
    return (
        <div
            className={classNames('', mods, [className])}
            {...otherProps}
        >
            {/*<svg id={attributesSvg.id}*/}
            {/*     width={attributesSvg.width}*/}
            {/*     height={attributesSvg.height}*/}
            {/*     viewBox={attributesSvg.viewBox}*/}
            {/*     version={attributesSvg.version}*/}
            {/*     xmlns={attributesSvg.xmlns}*/}
            {/*     xmlnsXlink={attributesSvg.xmlnsXlink}>*/}

            {/*    <defs>*/}
            {/*        <style>{`*/}
            {/*                .overlays text {font-family: "Helvetica, Arial, sans-serif"; fill: #949DA5; font-size: 16;}*/}
            {/*                .places rect {fill: #CCCCCC; fill-rule: nonzero;}*/}
            {/*                .places .booking {fill: #E99999;}*/}
            {/*                .places .sell {fill: #AEAEAE;}*/}
            {/*              `}</style>*/}
            {/*    </defs>*/}
            ...
            {/*    <g className="sectors">*/}
            {/*        <g id="parter" className="sector" sectorAlias="parter" sectorName="ПАРТЕР"></g>*/}
            {/*        <g id="amfiteatr" className="sector" sectorAlias="amfiteatr" sectorName="АМФИТЕАТР"></g>*/}
            {/*        <g id="beltaj_middle" className="sector" sectorAlias="beltaj_middle"*/}
            {/*           sectorName="БЕЛЬЭТАЖ СЕРЕДИНА"></g>*/}
            {/*        <g id="beltaj_left" className="sector" sectorAlias="beltaj_left"*/}
            {/*           sectorName="БЕЛЬЭТАЖ ЛЕВАЯ СТОРОНА"></g>*/}
            {/*        <g id="beltaj_right" className="sector" sectorAlias="beltaj_right"*/}
            {/*           sectorName="БЕЛЬЭТАЖ ПРАВАЯ СТОРОНА"></g>*/}
            {/*        <g id="first_level_middle" className="sector" sectorAlias="first_level_middle"*/}
            {/*           sectorName="ПЕРВЫЙ ЯРУС СЕРЕДИНА"></g>*/}
            {/*        <g id="first_level_left" className="sector" sectorAlias="first_level_left"*/}
            {/*           sectorName="ПЕРВЫЙ ЯРУС ЛЕВАЯ СТОРОНА"></g>*/}
            {/*        <g id="first_level_right" className="sector" sectorAlias="first_level_right"*/}
            {/*           sectorName="ПЕРВЫЙ ЯРУС ПРАВАЯ СТОРОНА"></g>*/}
            {/*        <g id="orchestry_bottom" className="sector" sectorAlias="orchestry_bottom"*/}
            {/*           sectorName="ОРКЕСТРОВАЯ ЯМА"></g>*/}
            {/*    </g>*/}
